...
export class SpaceMemberController {
  ...
  async create(req, res) {
    const member = await this.service.addMember(req.currentUser, req.validated.params.spaceId, req.validated.body);
...
export const spaceMemberController = new SpaceMemberController(spaceMemberService);
